...
/// This stores the Sqliteql Pool and the Main timers and a hash table that stores the SessionData.
/// It is also used to Initiate a Database Migrate, Cleanup, etc when used directly.
#[derive(Clone, Debug)]
pub struct SqliteSessionStore {
    //move to layer creation
    pub client: SqlitePool,
...
impl SqliteSessionStore {
    pub fn new(client: SqlitePool, config: SqlxSessionConfig) -> Self {
        Self {
            client,
